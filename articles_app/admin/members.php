	...
	if (isset($_SESSION['Username'])) {
		...
		<?php 
			...
			echo "<div class='container'>";
				...
				// check if members have article (true) delete the articles

				$stmt2 = $con->prepare("SELECT * FROM articles WHERE Member_ID = ?");
				...
				if($count > 0){
					...
					echo '<div class="alert alert-danger">YOU Can Not Delete This User</div>';
